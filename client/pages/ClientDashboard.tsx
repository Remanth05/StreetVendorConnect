...
import { ShoppingCart, Package, Clock, TrendingUp, Users, DollarSign } from "lucide-react";
                  ...
                  <div key={group.id} className="border-b border-gray-100 pb-4 last:border-b-0">
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-600 mb-1">
                          {group.participants} participants • {group.savings}% savings
                        </div>
                        <div className="text-xs text-gray-500">
