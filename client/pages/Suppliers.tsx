...
export default function Suppliers() {
  ...
  const categories = ["All", "Vegetables", "Spices", "Packaging", "Cooking Oil", "Dairy", "Grains"];
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Find Suppliers</h1>
          <p className="text-gray-600">Connect with verified suppliers in your area for the best deals</p>
        </div>
        ...
        <Card className="mt-8 bg-gradient-to-r from-brand-green to-brand-green-dark text-white border-0">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-green-100 mb-6">
              Request quotes from multiple suppliers or let us help you find the perfect match.
            </p>
